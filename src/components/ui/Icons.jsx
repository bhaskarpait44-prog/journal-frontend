...
export const IconAddTrade = (props) => (
  <Svg {...props}>
...
export const IconPsychology = (props) => (
  <Svg {...props}>
    <path d="M12 5c-1.5-2-5-2-6 0s1 4 4 6c-3 2-4.5 6-4.5 6" />
    <path d="M12 5c1.5-2 5-2 6 0s-1 4-4 6c3 2 4.5 6 4.5 6" />
  </Svg>
);
